	...
	def compute_z1(self, z0, z1, z2, b1, b2, l1_sparse_1, l1_sparse_2, l1_sparse_3):
		...
		for j in range(0, self.k):
			...
			if j == 0:
				...
				third_term += ((b2.T@l1_sparse_3_j.T).T)@z2@self.A[j,:,:]
	...
	def compute_z2(self, z1, z2, b2, l2_sparse_1, l2_sparse_2):
		...
		for j in range(0, self.k):
			...
			if j == 0:
				...
				second_term += ((b2@l2_sparse_2_j.T).T)@z1@self.A[j,:,:]
...
class MyNetwork(pl.LightningModule):
	def __init__(self, in_size, hid_dim, out_size, k_len, drop_out,alpha_leakyrelu,lr):
		super().__init__()
		self.k = k_len
		...
		#self.l3 = SAN(hid_dim, hid_dim,k=k_len,dropout=drop_out,alpha_leaky_relu=alpha_leakyrelu)
		#self.l4 = SAN(hid_dim, hid_dim,k=k_len,dropout=drop_out,alpha_leaky_relu=alpha_leakyrelu)
		...
		self.mlp1 = torch.nn.Linear(6*hid_dim, hid_dim)
	...
	def forward(self, batch):
		...
		# z0_prime_3, z1_prime_3, z2_prime_3 = self.l3(z0_prime_2, z1_prime_2, z2_prime_2, b1, b2)
		# #apply leaky relu to each z0_prime_3, z1_prime_3, z2_prime_3
		# z0_prime_3 = torch.nn.functional.leaky_relu(z0_prime_3, self.alpha_leakyrelu)
		# z1_prime_3 = torch.nn.functional.leaky_relu(z1_prime_3, self.alpha_leakyrelu)
		# z2_prime_3 = torch.nn.functional.leaky_relu(z2_prime_3, self.alpha_leakyrelu)


		# z0_prime_4, z1_prime_4, z2_prime_4 = self.l4(z0_prime_3, z1_prime_3, z2_prime_3, b1, b2)
		# #apply leaky relu to each z0_prime_4, z1_prime_4, z2_prime_4
		# z0_prime_4 = torch.nn.functional.leaky_relu(z0_prime_4, self.alpha_leakyrelu)
		# z1_prime_4 = torch.nn.functional.leaky_relu(z1_prime_4, self.alpha_leakyrelu)
		# z2_prime_4 = torch.nn.functional.leaky_relu(z2_prime_4, self.alpha_leakyrelu)
		...
		out = out.view(len(tri_index[0]), Z1.shape[1]*6)
	...
	def configure_optimizers(self):
		...
		#optimizer = torch.optim.AdamW(self.parameters(), lr=0.001, betas=(0.9, 0.999), eps=1e-08, weight_decay=1e-3)
		return optimizer
