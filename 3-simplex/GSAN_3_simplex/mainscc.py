...
#b2_val = b2_sparse.values()
    ...
    #     early_stop_callback = EarlyStopping(monitor="val_accuracy", min_delta=0.001, patience=200,verbose=False, mode="max")
    ...
    #{'lr': 0.015875377397311582, 'dropout': 0.03239716010229897, 'alpha_leaky_relu': 0.01901825087951187, 'k': 2, 'hid_dim': 34}
    
    #'lr': 0.019203564926982074, 'dropout': 0.03739819076384922, 'alpha_leaky_relu': 0.05066454839620265, 'k': 1, 'hid_dim': 77
    nn = MyNetwork(1,77,1,1,0.03739819076384922,0.05066454839620265,0.019203564926982074)
